    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      <div className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-10 ">
          <span className="section-label inline-flex items-center gap-2 mb-6 bg-[#3C220A] py-3 px-4 rounded-full text-sm font-medium text-[#F9620F] border-[#F9620F]">
      ...
      <div className="sticky top-20 z-40 bg-[#0a0a0a]/90 backdrop-blur-xl border-b border-[#262626]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="relative w-full md:w-80 bg-[#161616] text-neutral-500 rounded-xl border border-[#262626]">
              <input
                placeholder="ابحث في المقالات..."
                className=" w-full px-5 py-3 pr-12 transition-all duration-300
           focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 rounded-xl"
                type="text"
                value={search}
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <button className="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-gradient-to-r from-orange-500 to-orange-600 text-white cursor-pointer">
                جميع المقالات
              </button>

              <button className="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30 cursor-pointer">
                إضاءة
              </button>
              ...
              <button className="px-4 py-2 rounded-xl textsm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30 cursor-pointer">
                معدات
              </button>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 scroll-mt-[146px]">
        ...
        <div className="flex justify-center items-center gap-2 mt-12">
          <button
            ...
            className="p-3 cursor-pointer rounded-xl border transition-all duration-300 bg-[#161616] border-[#262626] text-white hover:border-orange-500/50 hover:bg-[#1a1a1a]"
            aria-label="السابق"
          >
          ...
          <div className="flex items-center gap-1">
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => (
              <button
                key={p}
                onClick={() => setPage(p)}
                className={`min-w-[44px] h-11 cursor-pointer rounded-xl text-sm font-medium transition-all duration-300 ${
                  p === page
